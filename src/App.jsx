            ...
            <div className="text-center p-4 bg-white rounded-lg shadow-md mt-4">
              ...
              <div className="bg-red-50 p-3 rounded-md border border-red-200 mt-1">
                ...
                <ul className="list-disc list-inside text-red-600 mt-1 text-left">
                  <li>
                    Continue your conversation with the AI and try again after a
                    few queries.
                  </li>
              ...
              <div className="bg-yellow-50 p-3 rounded-md border border-yellow-200 mt-3">
                ...
                <p className="mt-1 text-yellow-600">
                  Do <span className="font-bold">not</span> press the extension
                  button while the AI is still generating a response. Only click
                  after the response has been{" "}
                  <span className="font-bold">completely generated</span> to
